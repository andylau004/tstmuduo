...
inline void Person::clear_curname() {
  curname_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  _has_bits_[0] &= ~0x00000001u;
}
...
inline const std::string& Person::_internal_curname() const {
  return curname_.GetNoArena();
}
inline void Person::_internal_set_curname(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  curname_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
...
inline void Person::set_curname(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  curname_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void Person::set_curname(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000001u;
  curname_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:ContactInfo.Person.curName)
}
inline std::string* Person::_internal_mutable_curname() {
  _has_bits_[0] |= 0x00000001u;
  return curname_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Person::release_curname() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return curname_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void Person::set_allocated_curname(std::string* curname) {
  ...
  curname_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), curname);
...
inline void Person::clear_curemail() {
  curemail_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  _has_bits_[0] &= ~0x00000002u;
}
...
inline const std::string& Person::_internal_curemail() const {
  return curemail_.GetNoArena();
}
inline void Person::_internal_set_curemail(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  curemail_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void Person::set_curemail(std::string&& value) {
  _has_bits_[0] |= 0x00000002u;
  curemail_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void Person::set_curemail(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000002u;
  curemail_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void Person::set_curemail(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000002u;
  curemail_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:ContactInfo.Person.curEmail)
}
inline std::string* Person::_internal_mutable_curemail() {
  _has_bits_[0] |= 0x00000002u;
  return curemail_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* Person::release_curemail() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return curemail_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void Person::set_allocated_curemail(std::string* curemail) {
  ...
  curemail_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), curemail);
