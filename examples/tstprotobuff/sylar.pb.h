...
class AA PROTOBUF_FINAL :
 ...
 public:
  ...
  protected:
  explicit AA(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
...
class XX PROTOBUF_FINAL :
 ...
 public:
  ...
  protected:
  explicit XX(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
