...
CthriftClient::CthriftClient(const std::string &str_svr_appkey,
    ...
    : str_svr_appkey_(str_svr_appkey),
      str_cli_appkey_(""),
      i32_timeout_ms_(0 > i32_timeout_ms ? kI32DefaultTimeoutMsForClient : i32_timeout_ms),
...
CthriftClient::CthriftClient(const std::string &str_ip,
    ...
    : str_svr_appkey_(""),
      str_cli_appkey_(""),
      i32_timeout_ms_(0 > i32_timeout_ms ? kI32DefaultTimeoutMS : i32_timeout_ms),
      str_serviceName_filter_(""),
      i32_port_filter_(-1),
      b_parallel_(false),
      i32_async_pending_threshold_(DEFAULT_ASYNC_PENDING_THRESHOLD),
...
//                     << CurreCthriftTransportntThread::tid());
    ...
    boost::shared_ptr<CthriftTBinaryProtoWithCthriftTrans>
            sp_cthrift_tbinary_protocol_ =
            boost::make_shared<CthriftTBinaryProtoWithCthriftTrans>(sp_cthrift_transport_, CTHRIFT_CLIENT);
