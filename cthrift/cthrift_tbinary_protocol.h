...
typedef CthriftTBinaryProtocolFactoryT<TTransport> CthriftTBinaryProtocolFactory;
typedef CthriftTBinaryProtocolFactoryT<TMemoryBuffer> CthriftTAsyncProtocolFactory;

}  // namespace meituan_cthrift

#include "cthrift_tbinary_protocol.cc"
